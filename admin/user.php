<?php // $Id: user.php,v 1.109.2.4 2008/07/10 08:36:02 skodak Exp $
    ...
    if ($confirmuser and confirm_sesskey()) {
		...
		//if(createUserProfile($USER->username, $user)){		// NEW ************************
		...
		if ($result == AUTH_CONFIRM_OK or $result == AUTH_CONFIRM_ALREADY) {
			...
			*/
			...
			//deleteUserProfile($USER->username, $user);	// Added: to call calendar ws to delete user.
			//deleteQSUser($user);							// We shouldn't del user because still exists in moodle
