...
//////////////////////////////////////////////////////////
/// Custom Special Course & Context Keyword functions ////
//////////////////////////////////////////////////////////

function xmldb_update_instructions(){
    // Create Instructions Table
    $table = new XMLDBTable('instructions');

    if (!table_exists($table)) {
        echo "Need to Create - instructions<br/>";
    }else{
    ...
    /*
        ...
        $table->addFieldInfo('text', XMLDB_TYPE_CHAR, '6000', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addFieldInfo('count', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('active', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_typeid', XMLDB_KEY_FOREIGN, array('typeid'), 'instruction_type', array('id'));
        $table->addKeyInfo('fk_courseid', XMLDB_KEY_FOREIGN, array('courseid'), 'course', array('id'));

        // Create table for instructions
        drop_table($table);
        create_table($table);
        echo "Creating - instructions<br/>";
     */
}

function xmldb_scourse_upgrade() {

    global $CFG, $THEME, $USER, $DB;
    echo "<b>Create Tables</b><br/>";
    //$dbman = $DB->get_manager(); // loads ddl manager and xmldb classes

    // Create Special Course Table
    $table = new XMLDBTable('spc_courses');

    if (!table_exists($table)) {
        
        $table->addFieldInfo('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null, null, null);
        $table->addFieldInfo('courseid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('quizid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('categoryid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('name', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_courseid', XMLDB_KEY_FOREIGN, array('courseid'), 'course', array('id'));
        $table->addKeyInfo('fk_categoryid', XMLDB_KEY_FOREIGN, array('categoryid'), 'question_categories', array('id'));
        $table->addKeyInfo('fk_quizid', XMLDB_KEY_FOREIGN, array('quizid'), 'quiz', array('id'));

        // Create table for spc_courses
        create_table($table);
        echo "Creating - spc_courses<br/>";
    }else{
        echo "spc_courses - Exists<br/>";
    }

    // Create Special Course Categories Table
    $table = new XMLDBTable('spc_question_categories');

    if (!table_exists($table)) {
        $table->addFieldInfo('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null, null, null);
        $table->addFieldInfo('name', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addFieldInfo('desc', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addFieldInfo('categoryid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_categoryid', XMLDB_KEY_FOREIGN, array('categoryid'), 'question_categories', array('id'));

        // Create table for spc_question_categories
        create_table($table);
        echo "Creating - spc_question_categories<br/>";
    }else{
        echo "spc_question_categories - Exists<br/>";
    }

    // Context Keys - << Keyword >>

    // Create Context_Key_Groups Table
    $table = new XMLDBTable('context_key_groups');
    ...
    if (!table_exists($table)) {
        ...
        // Create table for context_key_groups
        create_table($table);
        echo "Creating - context_key_groups<br/>";
    }else{
        echo "context_key_groups - Exists<br/>";
    }

    // Create Quiz_Context_Keys Table
    $table = new XMLDBTable('quiz_context_keys');

    if (!table_exists($table)) {
        $table->addFieldInfo('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null, null, null);
        $table->addFieldInfo('courseid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('key_id', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('key_code', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_courseid', XMLDB_KEY_FOREIGN, array('courseid'), 'course', array('id'));

        // Create table for quiz_context_keys
        create_table($table);
        echo "Creating - quiz_context_keys<br/>";
    }else{
        echo "quiz_context_keys - Exists<br/>";
    }

    // Create Quiz_Context_Quiz_Attempts Table
    $table = new XMLDBTable('context_quiz_attempts');

    if (!table_exists($table)) {
        $table->addFieldInfo('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null, null, null);
        $table->addFieldInfo('courseid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('key_group', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('quiz_attempt', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_key_group', XMLDB_KEY_FOREIGN, array('key_group'), 'context_key_groups', array('id'));
        $table->addKeyInfo('fk_quiz_attempt', XMLDB_KEY_FOREIGN, array('quiz_attempt'), 'quiz_attempts', array('uniqueid'));
        $table->addKeyInfo('fk_courseid', XMLDB_KEY_FOREIGN, array('courseid'), 'course', array('id'));

        // Create table for context_quiz_attempts
        create_table($table);
        echo "Creating - context_quiz_attempts<br/>";
    }else{
        echo "context_quiz_attempts - Exists<br/>";
    }

    // Create Context_Key_Words Table
    $table = new XMLDBTable('context_key_words');
    ...
    if (!table_exists($table)) {
        ...
        $table->addFieldInfo('key_group', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('key_id', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('keyword', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_key_group', XMLDB_KEY_FOREIGN, array('key_group'), 'context_key_groups', array('id'));
        $table->addKeyInfo('fk_key_id', XMLDB_KEY_FOREIGN, array('key_id'), 'quiz_context_keys', array('key_id'));
        $table->addKeyInfo('fk_courseid', XMLDB_KEY_FOREIGN, array('courseid'), 'course', array('id'));

        // Create table for context_key_words
        create_table($table);
        echo "Creating - context_key_words<br/>";
    }else{
...
// Instructions
    ...
    // Create Instructions Type Table
    $table = new XMLDBTable('instructions_type');
    ...
    if (!table_exists($table)) {
        ...
        // Create table for instruction_type
        create_table($table);
        echo "Creating - instruction_type<br/>";
    }else{
    ...
    // Create Exam_Quiz_Context Table
    $table = new XMLDBTable('exam_quiz_context');
    ...
    if (!table_exists($table)) {
        ...
        $table->addFieldInfo('instr1_id', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('instr2_id', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_contextid', XMLDB_KEY_FOREIGN, array('contextid'), 'context_key_groups', array('id'));
        $table->addKeyInfo('fk_instr1_id', XMLDB_KEY_FOREIGN, array('instr1_id'), 'instructions', array('id'));
        $table->addKeyInfo('fk_instr2_id', XMLDB_KEY_FOREIGN, array('instr2_id'), 'instructions', array('id'));
        $table->addKeyInfo('fk_courseid', XMLDB_KEY_FOREIGN, array('courseid'), 'course', array('id'));
        $table->addKeyInfo('fk_quizid', XMLDB_KEY_FOREIGN, array('quizid'), 'quiz', array('id'));

        // Create table for exam_quiz_context
        create_table($table);
        echo "Creating - exam_quiz_context<br/>";
    }else{
    ...
    // Create Quiz_Course_Activation Table
    $table = new XMLDBTable('quiz_course_activation');

    if (!table_exists($table)) {
        $table->addFieldInfo('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null, null, null);
        //$table->addFieldInfo('firstname', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        //$table->addFieldInfo('lastname', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addFieldInfo('courseid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('quizid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
        $table->addFieldInfo('username', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addFieldInfo('attemptid', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addFieldInfo('url', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null, null, null);
        $table->addFieldInfo('starttime', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
        $table->addFieldInfo('endtime', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
        $table->addFieldInfo('grade1', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null);
        $table->addFieldInfo('grade2', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null);
        $table->addFieldInfo('exam_context', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, null, null);
        $table->addKeyInfo('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->addKeyInfo('fk_username', XMLDB_KEY_FOREIGN, array('username'), 'user', array('username'));
        $table->addKeyInfo('fk_quizid', XMLDB_KEY_FOREIGN, array('quiz'), 'quiz', array('id'));
        $table->addKeyInfo('fk_courseid', XMLDB_KEY_FOREIGN, array('courseid'), 'course', array('id'));
        $table->addKeyInfo('fk_attemptid', XMLDB_KEY_FOREIGN, array('attemptid'), 'quiz_attempts', array('id'));
        $table->addKeyInfo('fk_exam_context', XMLDB_KEY_FOREIGN, array('exam_context'), 'exam_quiz_context', array('id'));
        // Create table for quiz_course_activation
        create_table($table);
        echo "Creating - quiz_course_activation<br/>";
    }else{
