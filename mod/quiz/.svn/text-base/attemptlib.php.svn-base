...
class quiz_attempt extends quiz {
    ...
    public function print_question($id, $reviewing, $thispageurl = '') {
        ...
        $actual = print_question($this->questions[$id], $this->states[$id], $this->questions[$id]->_number,
                $this->quiz, $options);
        return $actual;
    }

    public function get_actual_id($id, $reviewing, $thispageurl = ''){
        
        return get_actual_id($this->questions[$id], $this->states[$id], $this->questions[$id]->_number,
                $this->quiz, $options);
    }
