...
$(document).ready(function(){
	var div ="";
	div += '<center>';
	div += '<img id="fiuNetworkDiagram" src="embedded/img/K2-3_Network-Diagram.png" usemap="#Image-Map-1" border="0" width="762" height="838" alt="ITTC & ForKidz Network Diagrams" class="style1" />';
	div += '<map name="Image-Map-1">';
	div += '  <area id="area_1" shape="rect" coords="525,85,725,235" href="<?php echo $_GET["kaseyaServer"]; ?>" alt="Kaseya Server" target="_blank" onmouseover="xstooltip_show(\'tooltip_1\', \'fiuNetworkDiagram\', 525, 165);" onmouseout="xstooltip_hide(\'tooltip_1\');" />';
	div += '  <area id="area_2" shape="rect" coords="250,425,440,695" nohref="webRDP.php?tab=tab0&hostName=<?php echo $_GET["hostName0"]; ?>&hostPort=<?php echo $_GET["hostPort0"]; ?>&username=<?php echo $_GET["username0"]; ?>&password=<?php echo $_GET["password0"]; ?>&domain=<?php echo $_GET["domain0"]; ?>&bottomFrameHeightPercentage=<?php echo $_GET["bottomFrameHeightPercentage"]; ?>" alt="<?php echo $_GET["vmName0"]; ?>" onmouseover="xstooltip_show(\'tooltip_2\', \'fiuNetworkDiagram\', 250, 265);" onmouseout="xstooltip_hide(\'tooltip_2\');" />';
	div += '  <area id="area_3" shape="rect" coords="20,395,210,555"   nohref="webRDP.php?tab=tab1&hostName=<?php echo $_GET["hostName1"]; ?>&hostPort=<?php echo $_GET["hostPort1"]; ?>&username=<?php echo $_GET["username1"]; ?>&password=<?php echo $_GET["password1"]; ?>&domain=<?php echo $_GET["domain1"]; ?>&bottomFrameHeightPercentage=<?php echo $_GET["bottomFrameHeightPercentage"]; ?>" alt="<?php echo $_GET["vmName1"]; ?>" onmouseover="xstooltip_show(\'tooltip_3\', \'fiuNetworkDiagram\', 20 , 195);" onmouseout="xstooltip_hide(\'tooltip_3\');" />';
	div += '  <area id="area_4" shape="rect" coords="20,555,210,715" nohref="webRDP.php?tab=tab2&hostName=<?php echo $_GET["hostName2"]; ?>&hostPort=<?php echo $_GET["hostPort2"]; ?>&username=<?php echo $_GET["username2"]; ?>&password=<?php echo $_GET["password2"]; ?>&domain=<?php echo $_GET["domain2"]; ?>&bottomFrameHeightPercentage=<?php echo $_GET["bottomFrameHeightPercentage"]; ?>" alt="<?php echo $_GET["vmName2"]; ?>" onmouseover="xstooltip_show(\'tooltip_4\', \'fiuNetworkDiagram\', 20 , 215);" onmouseout="xstooltip_hide(\'tooltip_4\');" />';
	div += '  <area id="area_5" shape="rect" coords="515,595,750,715" nohref="webRDP.php?tab=tab3&hostName=<?php echo $_GET["hostName3"]; ?>&hostPort=<?php echo $_GET["hostPort3"]; ?>&username=<?php echo $_GET["username3"]; ?>&password=<?php echo $_GET["password3"]; ?>&domain=<?php echo $_GET["domain3"]; ?>&bottomFrameHeightPercentage=<?php echo $_GET["bottomFrameHeightPercentage"]; ?>" alt="<?php echo $_GET["vmName3"]; ?>" onmouseover="xstooltip_show(\'tooltip_5\', \'fiuNetworkDiagram\', 560, 255);" onmouseout="xstooltip_hide(\'tooltip_5\');" />';
	div += '  <area id="area_6" shape="rect" coords="515,440,750,595" nohref="webRDP.php?tab=tab4&hostName=<?php echo $_GET["hostName4"]; ?>&hostPort=<?php echo $_GET["hostPort4"]; ?>&username=<?php echo $_GET["username4"]; ?>&password=<?php echo $_GET["password4"]; ?>&domain=<?php echo $_GET["domain4"]; ?>&bottomFrameHeightPercentage=<?php echo $_GET["bottomFrameHeightPercentage"]; ?>" alt="<?php echo $_GET["vmName4"]; ?>" onmouseover="xstooltip_show(\'tooltip_6\', \'fiuNetworkDiagram\', 560, 235);" onmouseout="xstooltip_hide(\'tooltip_6\');" />';
	div += '</map>';
    ...
    //alert(div);
	$("#area_2, #area_3, #area_4, #area_5, #area_6").click(function(event){ 
