		...
		success: function(vms) {
			...
			if(vms != null) {
				...
				if (vms.success) {
					...
					$("#devaTabs").append('<a id="devaInfo" class="devaTabs ui-corner-all" href="devaInfo.php?kaseyaServer='+kaseyaServer+'&vmName0='+vms.vmInfo[0].name+'&vmName1='+vms.vmInfo[1].name+'&vmName2='+vms.vmInfo[2].name+'&vmName3='+vms.vmInfo[3].name+'&vmName4='+vms.vmInfo[4].name+'&hostName='+vms.vmInfo[0].accessAddress+'&hostPort0='+vms.vmInfo[0].accessPort+'&hostPort1='+vms.vmInfo[1].accessPort+'&hostPort2='+vms.vmInfo[2].accessPort+'&hostPort3='+vms.vmInfo[3].accessPort+'&hostPort4='+vms.vmInfo[4].accessPort+'&username='+vms.vmInfo[0].username+'&password='+vms.vmInfo[0].password+'&domain='+vms.vmInfo[0].domain+'&bottomFrameHeightPercentage='+bottomFrameHeightPercentage+'" target="tab0Content"><span>Connection Info</span></a>&nbsp;');
											
					for (var i=0; i<vms.vmInfo.length; i++) {
						// Deva Tabs
						$("#devaTabs").append('<a id="tab'+i+'" class="devaTabs ui-corner-all" href="webRDP.php?tab=tab'+i+'&hostName='+vms.vmInfo[i].accessAddress+'&hostPort='+vms.vmInfo[i].accessPort+'&username='+vms.vmInfo[i].username+'&password='+vms.vmInfo[i].password+'&domain='+vms.vmInfo[i].domain+'&bottomFrameHeightPercentage='+bottomFrameHeightPercentage+'" target="tab1Content"><span>'+vms.vmInfo[i].name+'</span></a>&nbsp;');
					}
					...
					div += '<IFRAME name="tab0Content" id="tab0Contentid"'; 
					...
					div += '	<A target=_blank HREF="http://localhost:8888/moodle19/mod/deva/devaGraph.php?kaseyaServer=http://kaseya2.cis.fiu.edu/&vmName0=Domain%20Controller%20(dc)&vmName1=Workstation%201%20(ws1)&vmName2=Guest%201%20(guest1)&vmName3=PC%201%20(pc1)&vmName4=Laptop%201%20(laptop1)&hostName=serval.cis.fiu.edu&hostPort0=10001&hostPort1=10002&hostPort2=10003&hostPort3=10004&hostPort4=10005&username=Administrator&password=k4se*prt4l&domain=FIU&bottomFrameHeightPercentage=97">';
					...
					div  = "";
					div += '<div id="tab1ContentIFrame" class="tabContentIFrame" align="center" style="display: none;">';
					div += '<IFRAME name="tab1Content" id="tab1Contentid"'; 
					// div += '    SRC="devaGraph.php?kaseyaServer='+kaseyaServer+'&vmName0='+vms.vmInfo[0].name+'&vmName1='+vms.vmInfo[1].name+'&vmName2='+vms.vmInfo[2].name+'&vmName3='+vms.vmInfo[3].name+'&vmName4='+vms.vmInfo[4].name+'&hostName='+vms.vmInfo[0].accessAddress+'&hostPort0='+vms.vmInfo[0].accessPort+'&hostPort1='+vms.vmInfo[1].accessPort+'&hostPort2='+vms.vmInfo[2].accessPort+'&hostPort3='+vms.vmInfo[3].accessPort+'&hostPort4='+vms.vmInfo[4].accessPort+'&username='+vms.vmInfo[0].username+'&password='+vms.vmInfo[0].password+'&domain='+vms.vmInfo[0].domain+'&bottomFrameHeightPercentage='+bottomFrameHeightPercentage+'"'; 
					div += '	SRC="devaGraph.php?'+
						'kaseyaServer='+kaseyaServer+
						'&vmName0='+vms.vmInfo[0].name+
...
{
	// alert("Hi!");
  document.getElementById('tab0Contentid').style.height = parseInt(newHeight) + 10 + 'px';
}
