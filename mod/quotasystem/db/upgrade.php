...
function xmldb_quotasystem_upgrade($oldversion=0) {
...
/// for demonstrative purposes and to show how the quotasystem
/// iself has been upgraded.

/// For each upgrade block, the file quotasystem/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to quotasystem
        $table = new XMLDBTable('quotasystem');
        $field = new XMLDBField('course');
        $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    /// Launch add field course
        $result = $result && add_field($table, $field);

    /// Define field intro to be added to quotasystem
        $table = new XMLDBTable('quotasystem');
    ...
    /// Define field introformat to be added to quotasystem
        $table = new XMLDBTable('quotasystem');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to quotasystem
        $table = new XMLDBTable('quotasystem');
    ...
    /// Define field timemodified to be added to quotasystem
        $table = new XMLDBTable('quotasystem');
    ...
    /// Define index course (not unique) to be added to quotasystem
        $table = new XMLDBTable('quotasystem');
...
/// Third example, the next day, 20070402 (with the trailing 00), some inserts were performed, related with the module
    ...
    /// Add some actions to get them properly displayed in the logs
        $rec = new stdClass;
        $rec->module = 'quotasystem';
        $rec->action = 'add';
        $rec->mtable = 'quotasystem';
        $rec->filed  = 'name';
