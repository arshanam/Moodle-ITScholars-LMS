...
$result = mysql_query("SELECT * FROM mdl_quiz_course_activation");
...
echo "</table>";
*/
$result = mysql_query("SELECT * FROM mdl_quiz_attempts WHERE userid=114");
//WHERE quiz = 28 AND userid=114
