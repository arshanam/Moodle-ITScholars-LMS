        ...
        if($cnt){
            ...
            if(!empty($quizzes)){
                foreach ($quizzes as $quiz) {
                    ...
                    echo "<table id='tablesorter' class='grades boxwidthwide boxaligncenter generalbox' border='0' cellpadding='5' cellspacing='5'>";
                    ...
                    if(!empty($userview) && $hasRecords > 0){
                        ...
                        if(!empty($param->edit) && ($quiz->id == $param->edit)){
                            echo "<td colspan='4'><a href='$CFG->wwwroot/'><font color='black'>Return to Main</font></a> | ";
        ...
        if($cnt){
            ...
            if(!empty($quizzes)){
                ...
                foreach ($quizzes as $quiz) {
                    ...
                    echo "<table id='tablesorter' class='grades boxwidthwide boxaligncenter generalbox' border='0' cellpadding='5' cellspacing='5' width='1000px'>";
