...
// --------------------------------------------------------  Edited: JAM - 11/19/2010 (below)
$string['emailadminconfirmation'] = 'Hi $a->firstname,

A new account has been requested at \'$a->sitename\' using your email address.

Once your account is confirmed, you will be notified. Note that this process may take up to 24 hours. However, if you were told that you would need to first attend an orientation session, your account would be confirmed right before your scheduled orientation session.

Once your account is confirmed, you can login at this web address:
...
Should you have any more questions or need help, please do not hesitate to contact the site administrator. 

Best regards,
$a->admin';
// -------------------------------------------------------- End of Modifcation
// --------------------------------------------------------  Added: SMS - 1/6/2011 (below)
$string['emailadminconfirmationwithlink'] = 'Hi $a->firstname,

A new account has been requested at \'$a->sitename\' using your email address.

To confirm your account, you would need to visit the below link:
...
$a->admin';
// -------------------------------------------------------- End of Modifcation
// --------------------------------------------------------  Added: JAM - 11/19/2010 (below) 
$string['sendemailadminconfirmation'] = 'Hi,
...
Skype or Google Talk ID: $a->skypeid
...
Kaseya Customer ID: $a->kaseyacustomerid
Email or name of your Kaseya Sales Rep: $a->kaseyasalesrep

The main topic of the course you are intending to enroll: $a->maintopic
The delivery type or the bundle: $a->typebundle
        
First access: $a->firstaccess
Last access: $a->lastaccess

To confirm this new account, please click the following link:

$a->link

In most mail programs, this should appear as a blue link which you can just click on.  If that doesn\'t work, then cut and paste the address into the address line at the top of your web browser window.';
$string['emailadminconfirmationsubject'] = 'Account Requested: $a->fullname, $a->sitename';
// --------------------------------------------------------  Added: JAM - 05/07/2012 (below) 
$string['sendenrolmentnotifcation'] = 'Hi,

The student listed has enrolled in a course:
...
';
$string['sendenrolmentnotifcationsubject'] = 'Enrollment: $a->userfullname, $a->shortname, $a->fullname ';
$string['sendunenrolmentnotifcation'] = 'Hi,

The student listed has unenrolled from a course:
...
';
$string['sendunenrolmentnotifcationsubject'] = 'Unenrollment: $a->userfullname, $a->shortname, $a->fullname';
// sms: 7/6/2014 Added to support embedded version
$string['senddeletednotifcation'] = 'Hi,

The student listed has been deleted from vLab:
...
';
$string['senddeletednotifcationsubject'] = 'Deleted: $a->firstname $a->lastname';
// -------------------------------------------------------- 
$string['confirmationuseremail'] = 'Hi $a->firstname,

Your account has been confirmed at \'$a->sitename\' 
using your email address.

To login to your new account, please go to this web address:
...
If you need help, please contact the site administrator,
$a->admin';
$string['confirmationuseremailsubject'] = '$a: account confirmed';

$string['signuperroradminemail'] = 'Hi,

An error occured when a new account was requested for the user - $a->fullname.
...
This account could not be created, and does not exist in the database.';
$string['signuperroradminemailsubject'] = '$a: account request error';

$string['enrolmentrequestadminemail'] = 'Hi,

The following student has requested an enrollment key to the course:
...
';
$string['enrolmentrequestadminemailsubject'] = 'Enrollment Key Request: $a->userfullname, $a->shortname, $a->fullname';

// ------------------------------------------------------------------------------ For: moodle|web service error email
$string['moodle_webserviceerroremail'] = 'Hi,

A $a->errortype occured when a(n) $a->action action was requested.

$a->userlabel	$a->requester

$a->label:	$a->name
Id:			$a->id
			$a->email

The above action could not be completed.';
$string['webserviceerroremailsubject'] = '$a: Web Service Error';
$string['moodleerroremailsubject'] = '$a: Moodle Error';

// -------------------------------------------------------- End of Addition
// --------------------------------------------------------  Added: JAM - 11/23/2010 (below)
// - apointment creation, edit and delete emails
// Modification

$string['appointmentmodificationemailsubject'] = '$a: appointment modification';
$string['appointmentmodificationemail'] = 'Dear $a->fullname,

This is to confirm that the below appointments for $a->resourcetype for $a->course session(s) are modified: 

Original appointments:
$a->originalappointmentinfo

New appointments:
$a->newappointmentinfo

Should you have any question, please do not hesitate to contact us by sending an email to $a->fromemail.

Best regards,
$a->admin';
// Cancellation
$string['appointmentcancellationemailsubject'] = '$a: appointment cancellation';
$string['appointmentcancellationemail'] = 'Dear $a->fullname,

This is to confirm that the below appointments for $a->resourcetype for $a->course session(s) are canceled:
...
$a->admin';
// Confirmation
$string['appointmentconfirmationemailsubject'] = '$a: appointment confirmation';
$string['appointmentconfirmationemail'] = 'Dear $a->fullname,

Thank you for scheduling an appointment for a $a->resourcetype for $a->course. This email contains important information about your lab. Please make sure to save this email in a safe place so that you can refer to it when needed. Also, please make sure that your email system does not filter as spam future emails sent from $a->fromemail.

Your $a->resource session schedule follows: 

$a->confirmappointments

Note that you need to log on to the $a->portal using the user account the you created previously.

Once you logged on to the lab web site, you will need to click on the Scheduler link (located at the top left corner  of the page, under Main Menu) to be able to see your schedule and access to more information about your $a->resourcetype session. 

Note that the scheduled session starts sharp at $a->starttime and finishes sharp at $a->endtime. You are strongly encouraged to login to the system 5 to 10 minutes early to get oriented with the upcoming session.
...
// -------------------------------------------------------- End of Addition
$string['emailconfirmsent'] = '<p>An email should have been sent to your address at <b>$a->useremail</b>. It contains easy instructions to complete your registration.</p>
   
   <p>Your account would need to be first confirmed by the site administrator. Once your account is confirmed, you will be notified. Note that this process may take up to 24 hours. However, if you were told that you would need to first attend an orientation session, your account will be confirmed right before your scheduled orientation session. </p>
   
   <p>Should you have any questions, contact the site administrator <a href=\'mailto:$a->adminemail\'>$a->adminemail</a>.</p>';
...
An email containing your new password has been sent to your address at <b>$a->email</b>.<br /><br />
...
$string['loginsteps'] = 'If this is your first time visiting this Web site and you would like to request for an account, you need to fill out the <a href=\"$a\">New Account</a> form.  An email will be immediately sent to your email address, indicating that your request was sent to the site administrator. Once your account is confirmed, you will be notified. Note that this process may take up to 24 hours. However, if you were told that you would need to first attend an orientation session, your account will be confirmed right before your scheduled orientation session.
';
/*
...
$string['password'] = 'Password <br/>(max 14 char)';
...
$string['passwordforgotteninstructions'] = 'Your record must first be found in the system. Please enter <strong>either</strong> your username or your registered email address in the appropriate box. There is no need to enter both.';
