...
$string['confirmcertclose'] = 'You are about to close this attempt. Once you close the attempt you will no longer be able to access the questions and the virtual lab for this certification test. If you have not submitted your answer file already, please remeber to upload the file within the next ten minutes.';
...
$string['confirmstarttimelimitcert'] = 'Warning! You are about to start an attempt to take the Certification Test. If you continue by clicking on the \'Confirm\' button, you will NOT be able to cancel the test. If you have reached this page by mistake and/or you are NOT yet ready to take the certification test, simply click on the \'Cancel\' button and return to this page when you are ready.';
