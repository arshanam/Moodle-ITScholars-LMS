...
echo '<a href="'.$CFG->wwwroot.'/">'.$USER->firstname.' '.$USER->lastname.'</a>';
...
?>
    ...
    <td width="10" height="90" rowspan="2">

    <!--
    <td width="90" height="90" rowspan="2">
    <div class="header-profilepic" id="header-profilepic">
        <?PHP
